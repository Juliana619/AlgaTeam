...
label HelpFish:
    ...
    show Fish Happy at right with easeinright
    fish Normal "Юная русалка, я не знаю где твой хвост, но спасибо за то, что помогла мне!"
    val Shy "Ааа… ээээ? Даааа…. Не за что!"
    rix "Пфффхахахах, ты что, засмущалась от того, что тебя русалкой обозвали? Не забывай зачем мы здесь! Распроси ее об артефкате!"
    val "Рыбка… Красотка! Слушай, а у вас тут есть что-то типа артефекта? Местной реликвии? Какой-то штуки, которая имеет силу?"
